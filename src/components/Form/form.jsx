...
const Form = ({submitSearch}) => {
  ...
  return (
    <form
      onSubmit={onSubmit}
      className="w-full px-5 md:text-2xl sm:text-sm lg:text-2xl"
    >
      <div className="relative z-1 mb-8 w-full group">
        <input
          type="text"
      ...
      <button
        onClick={onSubmit}
        type="submit"
        className="text-white bg-gradient-to-r from-teal-400 via-teal-500 to-teal-600 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-teal-300 dark:focus:ring-teal-800 shadow-lg shadow-teal-500/50 dark:shadow-lg dark:shadow-teal-800/80 font-medium rounded-lg px-5 py-2.5 text-center inline-flex items-center justify-center mr-2 mb-2 w-full"
      >
